...
export default function UploadPage({ user, onNavigate }) {
  ...
  if (!user) return (
    <div style={{ textAlign:'center', padding:'100px 24px' }}>
      ...
      <button onClick={()=>onNavigate('home')} style={{ background:C.blurple, color:'#fff', border:'none', borderRadius:8, padding:'12px 28px', fontSize:15, fontWeight:700 }}>Login with Discord</button>
    </div>
  )
