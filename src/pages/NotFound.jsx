      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginTop: 20 }}>
          <a href="/" style={linkStyle}>
            <button style={{ ...btnBase, background: 'none', color: C.text, border: `1px solid ${C.border}` }}>Home</button>
          </a>
          ...
          <a href="/api/auth/discord" style={linkStyle}>
            <button style={{ ...btnBase, background: 'transparent', color: C.blurple, border: `1px solid ${C.blurple}` }}>Log in</button>
          </a>
        </div>
      </div>
    </div>
