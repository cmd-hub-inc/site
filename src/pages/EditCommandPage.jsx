    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '60px 24px' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              background: saving ? '#4b59d6' : '#5865F2',
              color: '#fff',
              border: 'none',
              padding: '8px 14px',
              borderRadius: 8,
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 18 }}>
        ...
        >
          ...
          <select
            value={cmd.uploadCategory || 'Framework'}
            onChange={(e) => handleChange('uploadCategory', e.target.value)}
            style={{
              width: '100%',
              padding: 10,
              borderRadius: 8,
          ...
          >
            ...
            >
              {(() => {
                try {
                  const parsed =
                    typeof cmd.rawData === 'string'
                      ? JSON.parse(cmd.rawData || '{}')
                      : cmd.rawData || {};
                  return (
                    <pre
                      style={{
